...
import 'package:sezon/src/modules/_app/ui/widgets/add_address_widget/add_address_widget.dart';
import 'package:sezon/src/modules/_app/ui/widgets/add_address_widget/add_address_widget_controller.dart';
import 'package:sezon/src/modules/_app/ui/widgets/add_order_details_widget/add_order_details_widget_controller.dart';
    ...
    Helpers.showConfirmation(
      ...
      onConfirm: () async {
        try {
          ...
          Get.offAllNamed(AppRouter.main, arguments: {
            'initialIndex': 2,
          });
        } catch (error) {
